...
3. **Register it** in your instance's catalog (the instance: [`../instance/<your-instance>/skills/INDEX.md`](../instance/<your-instance>/skills/INDEX.md)) — drop the file under `instance/<you>/skills/` and add a row.
...
The framework defines the *model*; each instance provides its own concrete skills. **the instance's five live in [`../instance/<your-instance>/skills/`](../instance/<your-instance>/skills/INDEX.md).** A fork adds its own under `instance/<you>/skills/`.
