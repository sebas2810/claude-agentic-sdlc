...
seat's Claude model (defaults: pm + quality-engineer → opus, others → sonnet; the workers a seat starts run at their item's `tier:` label instead, see `workflow/fresh-context-workers.md`) ·
