...
> Stands under the ORBIS Agentic SDLC spine ([`../../agentic-operating-model.md`](../../agentic-operating-model.md)). This rule is the spine's invariant 1 (fixed countable human touchpoints) + invariant 8 (deliberate, not burst) + Principle 7 (explicit stop condition: finish, report, stop). Already coherent with the spine; confirmed, not rewritten.
